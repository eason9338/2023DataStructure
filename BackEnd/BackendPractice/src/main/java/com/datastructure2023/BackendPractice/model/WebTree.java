...
public class WebTree {
    public WebNode root;
    public ArrayList<WebPage> highScorePages;
    ...
    public ArrayList<WebPage> getHighScorePages(double scoreThreshold, WebNode root) {
        ArrayList<WebPage> highScorePages = new ArrayList<>();
        for(WebNode webNode: root.children) {
            if(webNode.nodeScore >= scoreThreshold) {
                highScorePages.add(webNode.webPage);
            }
        }
